...
Dialog::Dialog(QWidget *parent) :QDialog(parent), ui(new Ui::Dialog)
{
    ...
    if (_serv->doStartServer(QHostAddress::LocalHost, 8080))
    {
...
void Dialog::onAddUserToGui(QString name)
{
    ...
    lwUsers.append(name);
    // messagesDatabase.insert(name, QVector<QString>());
    _serv->messagesDatabase.insert(name, QVector<QString>());
